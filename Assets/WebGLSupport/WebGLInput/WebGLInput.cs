...
namespace WebGLSupport
{
    internal class WebGLInputPlugin
    {
        ...
        [DllImport("__Internal")]
        public static extern void WebGLInputTab(int id, System.Action<int, int> cb);

        [DllImport("__Internal")]
        public static extern void WebGLInputFocus(int id);

        [DllImport("__Internal")]
        public static extern void WebGLInputOnFocus(int id, System.Action<int> cb);

        [DllImport("__Internal")]
        public static extern void WebGLInputOnBlur(int id, System.Action<int> cb);

        [DllImport("__Internal")]
        public static extern void WebGLInputOnValueChange(int id, System.Action<int, string> cb);
        
        [DllImport("__Internal")]
        public static extern void WebGLInputOnEditEnd(int id, System.Action<int, string> cb);
        ...
        public static void WebGLInputTab(int id, System.Action<int, int> cb) { }
        public static void WebGLInputFocus(int id) { }
        public static void WebGLInputOnFocus(int id, System.Action<int> cb) { }
        public static void WebGLInputOnBlur(int id, System.Action<int> cb) { }
        public static void WebGLInputOnValueChange(int id, System.Action<int, string> cb) { }
        public static void WebGLInputOnEditEnd(int id, System.Action<int, string> cb) { }
    ...
    public class WebGLInput : MonoBehaviour, System.IComparable<WebGLInput>
    {
        ...
        private IInputField Setup()
        {
            ...
            throw new System.Exception("Can not Setup WebGLInput!!");
        }
