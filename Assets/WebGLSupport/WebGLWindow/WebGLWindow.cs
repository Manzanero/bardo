...
namespace WebGLSupport
{
    static class WebGLWindowPlugin
    {
        ...
        public static extern void WebGLWindowOnFocus(System.Action cb);

        [DllImport("__Internal")]
        public static extern void WebGLWindowOnBlur(System.Action cb);

        [DllImport("__Internal")]
        public static extern void WebGLWindowInjectFullscreen();

#else
        public static void WebGLWindowOnFocus(System.Action cb) { }
        public static void WebGLWindowOnBlur(System.Action cb) { }
    ...
    public static class WebGLWindow
    {
        ...
        public static event System.Action OnFocusEvent = () => { };
        public static event System.Action OnBlurEvent = () => { };
